...
import challengeWord from './../images/challengeWord.png';
...
function ChallengeWord() {
  ...
  return (  
    <div style={{width: "100vw", height: "100vh", position: "relative", backgroundColor: "#C757FF"}}>
        ...
        <img src={challengeWord} style={{width: "70vw", height: "52vh", position: "absolute", top: "19vh", left: "16vw"}} />
